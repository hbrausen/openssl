...
#  define GCM_FUNCREF_4BIT
#  undef  GHASH
void gcm_init_clmul_rv64gc_zbb_zbc(u128 Htable[16], const u64 Xi[2]);
void gcm_gmult_clmul_rv64gc_zbb_zbc(u64 Xi[2], const u128 Htable[16]);
# endif
#endif
